...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [2] = LAYOUT_staggered(
        ...
        KC_F4, KC_F5, KC_F6,           KC_NO,      KC_TAB,  KC_PLUS, KC_UNDS, KC_BSLS, KC_COLN,  KC_DLR, KC_H,   KC_J,   KC_K,    KC_L,   KC_SCLN,KC_NO ,  KC_BSPC,
        ...
        KC_0, KC_0,        KC_TRNS, KC_TRNS,KC_TRNS,  KC_LCTL, GUI,   ALT,  KC_NO,  KC_TRNS,  KC_TRNS, KC_TRNS, KC_NO, KC_RALT, KC_RGUI,   KC_RCTL,    RESET
    )
