...
#define VENDOR_ID       0xA415
#define PRODUCT_ID      0x0075
#define DEVICE_VER      0x0001
#define MANUFACTURER Ramon Imbao
#define PRODUCT Arisu75

/* key matrix size */
#define MATRIX_ROWS 6
#define MATRIX_COLS 15

#define MATRIX_COL_PINS { B11, B10, B2, B1, B0, A7, A3, B9, B8, B5, B4, B3, A15, A14, A9 }
#define MATRIX_ROW_PINS { F0, A0, F1, A4, A5, A6 }
